...
* [`docs/happygo-start-flow.md`](docs/happygo-start-flow.md) — что именно
  оригинал делает при запуске цикла и почему машина может сразу отрапортовать
  «готово».
* [`decompiled/`](decompiled/) — сами декомпилированные исходники приложения,
  из которых всё это восстановлено.
...
Ловушка с единицами: текущая температура в `0x00[3]` приходит в **°C**, а
установка и её границы (`0x15`, `0x16`) — в **°F**.
